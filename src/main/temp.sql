...
CREATE TABLE Rating(id_rating NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, quality_value VARCHAR2(50));

CREATE TABLE Identification(id_identification NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
                            fk_id_observation NUMBER NOT NULL,
                            fk_id_user NUMBER NOT NULL,
                            fk_id_rating NUMBER NOT NULL,
                            date_ TIMESTAMP,
                            FOREIGN KEY (fk_id_observation) REFERENCES Observation,
                            FOREIGN KEY (fk_id_user) REFERENCES USUARIO, FOREIGN KEY (fk_id_rating) REFERENCES Rating
);
...
INSERT INTO Rating(quality_value) VALUES ('Muy mala');
INSERT INTO Rating(quality_value) VALUES ('Mala');
INSERT INTO Rating(quality_value) VALUES ('Regular');
INSERT INTO Rating(quality_value) VALUES ('Buena');
INSERT INTO Rating(quality_value) VALUES ('Muy buena');
...
SELECT t.Name as Taxon,
       o.date_ as Fecha,
       co.latidude as Latitud,
       co.longitude as Longitud,
       p.first_name as Nombre,
       im.URL as URL
FROM Observation o, Taxonomia t, GPS_Coordinates co, USUARIO u, PERSON p, Image im
    WHERE t.id_taxonomy = o.fk_id_taxon and co.id_coordinates = o.fk_id_coordinates and o.fk_id_observer = u.id_usuario and u.fk_person_id = p.id_person and im.id_image = o.fk_id_image;

SELECT o.observation_id as id, o.fk_id_taxon,t.Name as Taxon, o.date_ as Fecha, co.latidude as Latitud,
                    co.longitude as Longitud, p.first_name as Nombre, im.URL as URL
